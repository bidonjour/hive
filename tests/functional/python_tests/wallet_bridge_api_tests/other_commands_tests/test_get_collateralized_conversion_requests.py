...
# TODO BUG LIST!
"""
1. Problem with running wallet_bridge_api.get_collateralized_conversion_requests with additional argument.
...
def test_with_correct_value(node, wallet):
    ...
    local_tools.prepare_node_with_set_collateral_convert_request(wallet)
...
# def test_additional_argument(node, wallet):
#     local_tools.prepare_node_with_set_collateral_convert_request(wallet)
#
#     node.api.wallet_bridge.get_collateralized_conversion_requests('alice', 'additional_argument')   # BUG1
