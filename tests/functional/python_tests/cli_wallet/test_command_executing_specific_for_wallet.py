...
def test_if_state_is_new_after_first_start(unconfigured_wallet: tt.Wallet):
    assert unconfigured_wallet.api.is_new() is True
    assert unconfigured_wallet.api.is_locked() is True


def test_if_state_is_locked_after_first_password_set(unconfigured_wallet: tt.Wallet):
    unconfigured_wallet.api.set_password(unconfigured_wallet.DEFAULT_PASSWORD)
    assert unconfigured_wallet.api.is_new() is False
    assert unconfigured_wallet.api.is_locked() is True


def test_if_state_is_unlocked_after_entering_password(unconfigured_wallet: tt.Wallet):
    unconfigured_wallet.api.set_password(unconfigured_wallet.DEFAULT_PASSWORD)
...
def test_if_state_is_locked_after_entering_password(unconfigured_wallet: tt.Wallet):
    unconfigured_wallet.api.set_password(unconfigured_wallet.DEFAULT_PASSWORD)
    unconfigured_wallet.api.unlock(unconfigured_wallet.DEFAULT_PASSWORD)
...
def test_if_state_is_locked_after_close_and_reopen(unconfigured_wallet: tt.Wallet):
    unconfigured_wallet.api.set_password(unconfigured_wallet.DEFAULT_PASSWORD)
    unconfigured_wallet.api.unlock(unconfigured_wallet.DEFAULT_PASSWORD)
